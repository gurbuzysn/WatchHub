namespace Web.Models
{
    public class PaginationInfoViewModel
    {
        ...
        public int TotalPages => (int)Math.Ceiling((double)TotalItems / Constants.Constants.ITEM_PER_PAGE);

        public bool HasPrevious => PageId > 1;
        public bool HasNext => PageId < TotalPages;
        public int RangeStart => (PageId - 1) * Constants.Constants.ITEM_PER_PAGE + 1;
